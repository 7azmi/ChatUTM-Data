...
if __name__ == "__main__":
    input_file = 'https://vscode.dev/github/7azmi/ChatUTM-Data/blob/chemical-chat/utm_data/whatsapp_groups/iss-yemen/ysag/Chemical/chemical.txt'  # Replace with your actual file name
